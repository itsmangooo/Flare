...
func displayAction(action string) string {
	if value, found := map[string]string{
		...
		"coolify.deployment_failed":    "Deployment failed",
		"coolify.deployment_recovered": "Deployment recovered",
		"coolify.disconnected":         "Coolify disconnected",
		"coolify.reconnected":          "Coolify reconnected",
		"cloudflare.disconnected":      "Cloudflare disconnected",
		"cloudflare.reconnected":       "Cloudflare reconnected",
		"cloudflare.tunnel.down":       "Tunnel unavailable",
		"cloudflare.tunnel.recovered":  "Tunnel recovered",
