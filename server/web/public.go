...
// Register mounts the embedded public status page and its assets.
func Register(router chi.Router, version string, database DatabasePinger, startedAt time.Time) {
...
// DatabasePinger is the minimal database dependency required by the status page.
