...
RUN dotnet publish src/Flare.Api/Flare.Api.csproj --configuration Release --no-restore \
    --output /app/publish /p:UseAppHost=false

FROM mcr.microsoft.com/dotnet/aspnet:10.0.8-noble-chiseled AS runtime
WORKDIR /app
