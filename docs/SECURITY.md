...
- The optional ntfy topic can act as a shared secret on servers without access control. Prefer a private topic plus a dedicated Bearer token, and never expose either value through the mobile API.
